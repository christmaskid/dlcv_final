...
class ConceptConductorPipeline(StableDiffusionPipeline): 
    ...
    def __call__(
        ...
        custom_attn_guidance_factor: List[float] = None, #float = 1.0,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for step, t in enumerate(timesteps):
                ...
                with torch.no_grad():  
                    ...
                    if visualization and ((step % 20 == 0) or (step < 2)):
                    ...
                    if  (step >= mask_refinement_start) and (step <= mask_refinement_end) and (step % mask_update_interval == 0):
                        # print('\nrefinemnt\n')
                        attention_controller.refine_feature_masks(fine_clustering=fine_clustering)      
                    # else:
